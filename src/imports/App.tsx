...
export default function App() {
  ...
  // 📧 Auto-process scheduled emails every 5 minutes (No external cron needed!)
  useEffect(() => {
    ...
    // Process emails immediately when user logs in
    if (accessToken) {
      processScheduledEmails();
    }

    // Then check every 5 minutes while user is logged in
