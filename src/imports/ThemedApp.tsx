    ...
    <div className={`min-h-screen ${bgGradient} flex`}>
      ...
      <div className="flex-1 md:ml-64">
       ...
       {activeView === 'profile' && (
        ...
        {activeView === 'food-db' && (
          <div className="flex-1 min-h-screen">
            <div className={`py-8 px-4 md:px-8 ${isDark ? 'text-white' : 'text-slate-800'}`}>
              <div className="mb-8">
                <h1 className="text-3xl font-bold mb-2">Nutritional Intelligence Database</h1>
                <p className={`text-lg ${isDark ? 'text-slate-400' : 'text-slate-600'}`}>
                  Explore 1,700+ nutrient-dense foods for brain and body health.
                </p>
              </div>
              <FoodDatabase />
            </div>
